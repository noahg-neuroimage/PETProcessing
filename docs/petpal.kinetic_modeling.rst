...
.. toctree::
   ...
   petpal.kinetic_modeling.graphical_analysis
   petpal.kinetic_modeling.parametric_images
   petpal.kinetic_modeling.reference_tissue_models
